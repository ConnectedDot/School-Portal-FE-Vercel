...
import { useTeacherAssignments } from '@/hooks/assignments';
        ...
        <div className="p-6">
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    {!isLoading && !isError && assignments.length === 0 && <p className="text-muted-foreground">No assignments created yet.</p>}
